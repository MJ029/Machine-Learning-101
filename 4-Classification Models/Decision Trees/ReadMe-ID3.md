...
- There something we have to look in when we are working with D-Trees and one of'em is ***Overfitting***. Please see more about how to avoid Overfitting in ID3 [click link](https://github.com/ManikandanJeyabal/Machine-Learning-101/tree/master/4-Classification%20Models/Decision%20Trees#5-over-fitting).
